														...
														<thead>
															<tr role="row">
																...
																<th class="sorting" tabindex="0"
																	...
																	style="width: 91.7891px;">UserId</th>
																<th class="sorting" tabindex="0"
																	aria-controls="example3" rowspan="1" colspan="1"
														...
														<tbody>
															<c:forEach items="${listCategory }" var="l">
																<tr role="row" class="odd">
																	...
																	<td>${l.categoryName}</td>
																	<td>${l.userId}</td>
																	<td><a class="btn btn-danger shadow btn-xs sharp"
																		href="deleteCategory?categoryId=${l.categoryId}"><i
																			class="fa fa-trash"></i></a> <%-- <a href="getDataByCatogeryId?categoryId=${l.categoryId}">Update</a> --%>
																		<a href="subCategory?categoryId=${l.categoryId}"><svg
																				...
																				<line x1="21" y1="12" x2="9" y2="12"></line></svg></a></td>
